...
$(default_exe_debug): bin/default/debug/int/bytecode.cpp.o bin/default/debug/int/first_pass_parser.cpp.o bin/default/debug/int/lexer.cpp.o bin/default/debug/int/main.cpp.o bin/default/debug/int/parser.cpp.o bin/default/debug/int/parse_context.cpp.o bin/default/debug/int/src_file.cpp.o bin/default/debug/int/expression.cpp.o bin/default/debug/int/statement.cpp.o bin/default/debug/int/typespec.cpp.o
...
bin/default/debug/int/src_file.cpp.o: ./src/src_file.cpp ./include/bz/allocator.h ./include/bz/core.h ./include/bz/format.h ./include/bz/iterator.h ./include/bz/meta.h ./include/bz/optional.h ./include/bz/string.h ./include/bz/string_view.h ./include/bz/variant.h ./include/bz/vector.h ./src/ast/../lexer.h ./src/ast/expression.h ./src/ast/node.h ./src/ast/statement.h ./src/ast/typespec.h ./src/bytecode.h ./src/colors.h ./src/core.h ./src/error.h ./src/first_pass_parser.h ./src/my_assert.h ./src/parse_context.h ./src/parser.h ./src/src_file.h
	$(CXX) $(default_cxx_debug_flags) $(addprefix -I,$(default_cxx_include_dirs)) $< -o $@

bin/default/release/int/src_file.cpp.o: ./src/src_file.cpp ./include/bz/allocator.h ./include/bz/core.h ./include/bz/format.h ./include/bz/iterator.h ./include/bz/meta.h ./include/bz/optional.h ./include/bz/string.h ./include/bz/string_view.h ./include/bz/variant.h ./include/bz/vector.h ./src/ast/../lexer.h ./src/ast/expression.h ./src/ast/node.h ./src/ast/statement.h ./src/ast/typespec.h ./src/bytecode.h ./src/colors.h ./src/core.h ./src/error.h ./src/first_pass_parser.h ./src/my_assert.h ./src/parse_context.h ./src/parser.h ./src/src_file.h
	$(CXX) $(default_cxx_release_flags) $(addprefix -I,$(default_cxx_include_dirs)) $< -o $@

bin/default/debug/int/expression.cpp.o: ./src/ast/expression.cpp ./include/bz/allocator.h ./include/bz/core.h ./include/bz/format.h ./include/bz/iterator.h ./include/bz/meta.h ./include/bz/optional.h ./include/bz/string.h ./include/bz/string_view.h ./include/bz/variant.h ./include/bz/vector.h ./src/ast/../lexer.h ./src/ast/expression.h ./src/ast/node.h ./src/ast/typespec.h ./src/bytecode.h ./src/core.h ./src/error.h ./src/my_assert.h
	$(CXX) $(default_cxx_debug_flags) $(addprefix -I,$(default_cxx_include_dirs)) $< -o $@
