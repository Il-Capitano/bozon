...
default_cxx := clang++
default_cxx_debug_flags := -c -g -Og -Wall -Wextra -march=native -ferror-limit=2 -std=c++2a
default_cxx_release_flags := -c -O3 -Wall -Wextra -march=native -ferror-limit=2 -std=c++2a
...
bin/default/debug/int/expression.cpp.o: ./src/ast/expression.cpp ./include/bz/allocator.h ./include/bz/core.h ./include/bz/format.h ./include/bz/iterator.h ./include/bz/meta.h ./include/bz/optional.h ./include/bz/result.h ./include/bz/string.h ./include/bz/string_view.h ./include/bz/u8string.h ./include/bz/u8string_view.h ./include/bz/variant.h ./include/bz/vector.h ./src/ast/expression.h ./src/ast/node.h ./src/ast/typespec.h ./src/core.h ./src/lex/token.h ./src/my_assert.h
	$(default_cxx) $(default_cxx_debug_flags) $(addprefix -I,$(default_cxx_include_dirs)) $< -o $@
...
test_cxx := clang++
test_cxx_debug_flags := -c -g -Og -Wall -Wextra -march=native -ferror-limit=2 -std=c++2a
test_cxx_release_flags := -c -O3 -Wall -Wextra -march=native -ferror-limit=2 -std=c++2a
...
bin/test/debug/int/test_main.cpp.o: ./test/test_main.cpp ./include/bz/allocator.h ./include/bz/core.h ./include/bz/format.h ./include/bz/iterator.h ./include/bz/meta.h ./include/bz/u8string.h ./include/bz/u8string_view.h ./include/bz/vector.h ./src/colors.h ./src/timer.h ./test/test.h
	$(test_cxx) $(test_cxx_debug_flags) $(addprefix -I,$(test_cxx_include_dirs)) $< -o $@

bin/test/release/int/test_main.cpp.o: ./test/test_main.cpp ./include/bz/allocator.h ./include/bz/core.h ./include/bz/format.h ./include/bz/iterator.h ./include/bz/meta.h ./include/bz/u8string.h ./include/bz/u8string_view.h ./include/bz/vector.h ./src/colors.h ./src/timer.h ./test/test.h
	$(test_cxx) $(test_cxx_release_flags) $(addprefix -I,$(test_cxx_include_dirs)) $< -o $@
