...
exec-debug: $(default_exe_debug)
	$(default_exe_debug) -Wall -Wno-unused-variable ./src/bitcode_test.bz

exec-release: $(default_exe_release)
	$(default_exe_release) -Wall -Wno-unused-variable ./src/bitcode_test.bz
...
bin/default/debug/int/src_manager.cpp.o: ./src/ctx/src_manager.cpp ./include/bz/allocator.h ./include/bz/array_view.h ./include/bz/core.h ./include/bz/format.h ./include/bz/iterator.h ./include/bz/meta.h ./include/bz/optional.h ./include/bz/result.h ./include/bz/string.h ./include/bz/string_view.h ./include/bz/u8string.h ./include/bz/u8string_view.h ./include/bz/variant.h ./include/bz/vector.h ./src/abi/calling_conventions.h ./src/ast/constant_value.h ./src/ast/expression.h ./src/ast/node.h ./src/ast/statement.h ./src/ast/typespec.h ./src/bc/emit_bitcode.h ./src/cl/clparser.h ./src/cl_options.h ./src/core.h ./src/ctx/bitcode_context.h ./src/ctx/command_parse_context.h ./src/ctx/decl_set.h ./src/ctx/error.h ./src/ctx/first_pass_parse_context.h ./src/ctx/global_context.h ./src/ctx/lex_context.h ./src/ctx/parse_context.h ./src/ctx/src_manager.h ./src/ctx/warnings.h ./src/global_data.h ./src/lex/file_iterator.h ./src/lex/lexer.h ./src/lex/token.h ./src/my_assert.h ./src/src_file.h ./src/token_info.h
	$(default_cxx) $(default_cxx_debug_flags) $(addprefix -I,$(default_cxx_include_dirs)) $< -o $@
...
linux-exec-debug: $(linux_exe_debug)
	$(linux_exe_debug) -Wall -Wno-unused-variable ./src/bitcode_test.bz

linux-exec-release: $(linux_exe_release)
	$(linux_exe_release) -Wall -Wno-unused-variable ./src/bitcode_test.bz
