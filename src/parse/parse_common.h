...
constexpr std::array statement_parsers = {
	statement_parser{ lex::token::kw_static_assert, &parse_stmt_static_assert,         both        },
	statement_parser{ lex::token::kw_let,           &parse_decl_variable,              both        },
	statement_parser{ lex::token::kw_const,         &parse_decl_variable,              both        },
	statement_parser{ lex::token::kw_consteval,     &parse_decl_variable,              both        },
	statement_parser{ lex::token::kw_function,      &parse_decl_function,              both        },
	statement_parser{ lex::token::kw_operator,      &parse_decl_operator,              both        },
