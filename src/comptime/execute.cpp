...
{
	auto const mem = context.get_memory(ptr, context.get_builtin_type(builtin_type_kind::i1));
...
{
	auto const mem = context.get_memory(ptr, context.get_builtin_type(builtin_type_kind::i8));
...
{
	auto const mem = context.get_memory(ptr, context.get_builtin_type(builtin_type_kind::i16));
...
{
	auto const mem = context.get_memory(ptr, context.get_builtin_type(builtin_type_kind::i32));
...
{
	auto const mem = context.get_memory(ptr, context.get_builtin_type(builtin_type_kind::i64));
...
{
	auto const mem = context.get_memory(ptr, context.get_builtin_type(builtin_type_kind::f32));
...
{
	auto const mem = context.get_memory(ptr, context.get_builtin_type(builtin_type_kind::f64));
...
{
	auto const mem = context.get_memory(ptr, context.get_pointer_type());
	return load_big_endian<uint32_t>(mem);
}
