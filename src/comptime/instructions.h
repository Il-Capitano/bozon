...
struct instruction : instruction_base_t
{
	...
	enum : base_t::index_t
	{
		...
		const_func_ptr           = index_of<instructions::const_func_ptr>,
		...
		check_inplace_construct  = index_of<instructions::check_inplace_construct>,
		check_destruct_value     = index_of<instructions::check_destruct_value>,
		...
		ptr32_diff_unchecked     = index_of<instructions::ptr32_diff_unchecked>,
		ptr64_diff_unchecked     = index_of<instructions::ptr64_diff_unchecked>,
