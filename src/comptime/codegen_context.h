...
struct codegen_context
{
	...
	instruction_ref create_float_cmp_eq_check(lex::src_tokens const &src_tokens, expr_value lhs, expr_value rhs);
	instruction_ref create_float_cmp_neq_check(lex::src_tokens const &src_tokens, expr_value lhs, expr_value rhs);
	instruction_ref create_float_cmp_lt_check(lex::src_tokens const &src_tokens, expr_value lhs, expr_value rhs);
	instruction_ref create_float_cmp_gt_check(lex::src_tokens const &src_tokens, expr_value lhs, expr_value rhs);
	instruction_ref create_float_cmp_lte_check(lex::src_tokens const &src_tokens, expr_value lhs, expr_value rhs);
	instruction_ref create_float_cmp_gte_check(lex::src_tokens const &src_tokens, expr_value lhs, expr_value rhs);
	...
	instruction_ref create_abs_check(lex::src_tokens const &src_tokens, expr_value value);
	expr_value create_int_min(expr_value a, expr_value b, bool is_signed);
	expr_value create_float_min(expr_value x, expr_value y);
	instruction_ref create_float_min_check(lex::src_tokens const &src_tokens, expr_value x, expr_value y);
	expr_value create_int_max(expr_value a, expr_value b, bool is_signed);
	expr_value create_float_max(expr_value x, expr_value y);
	instruction_ref create_float_max_check(lex::src_tokens const &src_tokens, expr_value x, expr_value y);
	expr_value create_exp(expr_value x);
	instruction_ref create_exp_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_exp2(expr_value x);
	instruction_ref create_exp2_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_expm1(expr_value x);
	instruction_ref create_expm1_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_log(expr_value x);
	instruction_ref create_log_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_log10(expr_value x);
	instruction_ref create_log10_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_log2(expr_value x);
	instruction_ref create_log2_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_log1p(expr_value x);
	instruction_ref create_log1p_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_sqrt(expr_value x);
	instruction_ref create_sqrt_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_pow(expr_value x, expr_value y);
	instruction_ref create_pow_check(lex::src_tokens const &src_tokens, expr_value x, expr_value y);
	expr_value create_cbrt(expr_value x);
	instruction_ref create_cbrt_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_hypot(expr_value x, expr_value y);
	instruction_ref create_hypot_check(lex::src_tokens const &src_tokens, expr_value x, expr_value y);
	expr_value create_sin(expr_value x);
	instruction_ref create_sin_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_cos(expr_value x);
	instruction_ref create_cos_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_tan(expr_value x);
	instruction_ref create_tan_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_asin(expr_value x);
	instruction_ref create_asin_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_acos(expr_value x);
	instruction_ref create_acos_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_atan(expr_value x);
	instruction_ref create_atan_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_atan2(expr_value y, expr_value x);
	instruction_ref create_atan2_check(lex::src_tokens const &src_tokens, expr_value y, expr_value x);
	expr_value create_sinh(expr_value x);
	instruction_ref create_sinh_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_cosh(expr_value x);
	instruction_ref create_cosh_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_tanh(expr_value x);
	instruction_ref create_tanh_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_asinh(expr_value x);
	instruction_ref create_asinh_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_acosh(expr_value x);
	instruction_ref create_acosh_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_atanh(expr_value x);
	instruction_ref create_atanh_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_erf(expr_value x);
	instruction_ref create_erf_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_erfc(expr_value x);
	instruction_ref create_erfc_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_tgamma(expr_value x);
	instruction_ref create_tgamma_check(lex::src_tokens const &src_tokens, expr_value x);
	expr_value create_lgamma(expr_value x);
	instruction_ref create_lgamma_check(lex::src_tokens const &src_tokens, expr_value x);
