...
static_assert(instruction::isnormal_f32             == instruction::index_of<instructions::isnormal_f32>);
static_assert(instruction::isnormal_f64             == instruction::index_of<instructions::isnormal_f64>);
static_assert(instruction::issubnormal_f32          == instruction::index_of<instructions::issubnormal_f32>);
...
static_assert(instruction::range_bounds_check_i64   == instruction::index_of<instructions::range_bounds_check_i64>);
static_assert(instruction::range_bounds_check_u64   == instruction::index_of<instructions::range_bounds_check_u64>);
...
bz::u8string to_string(instruction const &inst_, function const *func)
{
	...
	{
		auto const &inst = inst_.get<instructions::isnormal_f32>();
		return bz::format("isnormal f32 {}", inst.args[0]);
	}
	case instruction::isnormal_f64:
	{
		auto const &inst = inst_.get<instructions::isnormal_f64>();
		return bz::format("isnormal f64 {}", inst.args[0]);
	}
	case instruction::issubnormal_f32:
	{
		auto const &inst = inst_.get<instructions::issubnormal_f32>();
		return bz::format("issubnormal f32 {}", inst.args[0]);
	}
	case instruction::issubnormal_f64:
	{
		auto const &inst = inst_.get<instructions::issubnormal_f64>();
		return bz::format("issubnormal f64 {}", inst.args[0]);
	}
	case instruction::iszero_f32:
	{
		auto const &inst = inst_.get<instructions::iszero_f32>();
		return bz::format("iszero f32 {}", inst.args[0]);
	}
	...
	{
		auto const &inst = inst_.get<instructions::range_bounds_check_i64>();
		return bz::format("range-bounds-check i64 {}, {} ({})", inst.args[0], inst.args[1], inst.src_tokens_index);
	}
	case instruction::range_bounds_check_u64:
	{
		auto const &inst = inst_.get<instructions::range_bounds_check_u64>();
		return bz::format("range-bounds-check u64 {}, {} ({})", inst.args[0], inst.args[1], inst.src_tokens_index);
	}
...
static bz::array instruction_names = {
	bz::u8string_view("const_i1"),
	bz::u8string_view("const_i8"),
	bz::u8string_view("const_i16"),
	bz::u8string_view("const_i32"),
	bz::u8string_view("const_i64"),
	bz::u8string_view("const_u8"),
	bz::u8string_view("const_u16"),
	bz::u8string_view("const_u32"),
	bz::u8string_view("const_u64"),
	bz::u8string_view("const_f32"),
	bz::u8string_view("const_f64"),
	bz::u8string_view("const_ptr_null"),
	bz::u8string_view("const_func_ptr"),
	bz::u8string_view("get_global_address"),
	bz::u8string_view("get_function_arg"),
	bz::u8string_view("load_i1_be"),
	bz::u8string_view("load_i8_be"),
	bz::u8string_view("load_i16_be"),
	bz::u8string_view("load_i32_be"),
	bz::u8string_view("load_i64_be"),
	bz::u8string_view("load_f32_be"),
	bz::u8string_view("load_f64_be"),
	bz::u8string_view("load_ptr32_be"),
	bz::u8string_view("load_ptr64_be"),
	bz::u8string_view("load_i1_le"),
	bz::u8string_view("load_i8_le"),
	bz::u8string_view("load_i16_le"),
	bz::u8string_view("load_i32_le"),
	bz::u8string_view("load_i64_le"),
	bz::u8string_view("load_f32_le"),
	bz::u8string_view("load_f64_le"),
	bz::u8string_view("load_ptr32_le"),
	bz::u8string_view("load_ptr64_le"),
	bz::u8string_view("store_i1_be"),
	bz::u8string_view("store_i8_be"),
	bz::u8string_view("store_i16_be"),
	bz::u8string_view("store_i32_be"),
	bz::u8string_view("store_i64_be"),
	bz::u8string_view("store_f32_be"),
	bz::u8string_view("store_f64_be"),
	bz::u8string_view("store_ptr32_be"),
	bz::u8string_view("store_ptr64_be"),
	bz::u8string_view("store_i1_le"),
	bz::u8string_view("store_i8_le"),
	bz::u8string_view("store_i16_le"),
	bz::u8string_view("store_i32_le"),
	bz::u8string_view("store_i64_le"),
	bz::u8string_view("store_f32_le"),
	bz::u8string_view("store_f64_le"),
	bz::u8string_view("store_ptr32_le"),
	bz::u8string_view("store_ptr64_le"),
	bz::u8string_view("check_dereference"),
	bz::u8string_view("check_inplace_construct"),
	bz::u8string_view("check_destruct_value"),
	bz::u8string_view("cast_zext_i1_to_i8"),
	bz::u8string_view("cast_zext_i1_to_i16"),
	bz::u8string_view("cast_zext_i1_to_i32"),
	bz::u8string_view("cast_zext_i1_to_i64"),
	bz::u8string_view("cast_zext_i8_to_i16"),
	bz::u8string_view("cast_zext_i8_to_i32"),
	bz::u8string_view("cast_zext_i8_to_i64"),
	bz::u8string_view("cast_zext_i16_to_i32"),
	bz::u8string_view("cast_zext_i16_to_i64"),
	bz::u8string_view("cast_zext_i32_to_i64"),
	bz::u8string_view("cast_sext_i8_to_i16"),
	bz::u8string_view("cast_sext_i8_to_i32"),
	bz::u8string_view("cast_sext_i8_to_i64"),
	bz::u8string_view("cast_sext_i16_to_i32"),
	bz::u8string_view("cast_sext_i16_to_i64"),
	bz::u8string_view("cast_sext_i32_to_i64"),
	bz::u8string_view("cast_trunc_i64_to_i8"),
	bz::u8string_view("cast_trunc_i64_to_i16"),
	bz::u8string_view("cast_trunc_i64_to_i32"),
	bz::u8string_view("cast_trunc_i32_to_i8"),
	bz::u8string_view("cast_trunc_i32_to_i16"),
	bz::u8string_view("cast_trunc_i16_to_i8"),
	bz::u8string_view("cast_f32_to_f64"),
	bz::u8string_view("cast_f64_to_f32"),
	bz::u8string_view("cast_f32_to_i8"),
	bz::u8string_view("cast_f32_to_i16"),
	bz::u8string_view("cast_f32_to_i32"),
	bz::u8string_view("cast_f32_to_i64"),
	bz::u8string_view("cast_f32_to_u8"),
	bz::u8string_view("cast_f32_to_u16"),
	bz::u8string_view("cast_f32_to_u32"),
	bz::u8string_view("cast_f32_to_u64"),
	bz::u8string_view("cast_f64_to_i8"),
	bz::u8string_view("cast_f64_to_i16"),
	bz::u8string_view("cast_f64_to_i32"),
	bz::u8string_view("cast_f64_to_i64"),
	bz::u8string_view("cast_f64_to_u8"),
	bz::u8string_view("cast_f64_to_u16"),
	bz::u8string_view("cast_f64_to_u32"),
	bz::u8string_view("cast_f64_to_u64"),
	bz::u8string_view("cast_i8_to_f32"),
	bz::u8string_view("cast_i16_to_f32"),
	bz::u8string_view("cast_i32_to_f32"),
	bz::u8string_view("cast_i64_to_f32"),
	bz::u8string_view("cast_u8_to_f32"),
	bz::u8string_view("cast_u16_to_f32"),
	bz::u8string_view("cast_u32_to_f32"),
	bz::u8string_view("cast_u64_to_f32"),
	bz::u8string_view("cast_i8_to_f64"),
	bz::u8string_view("cast_i16_to_f64"),
	bz::u8string_view("cast_i32_to_f64"),
	bz::u8string_view("cast_i64_to_f64"),
	bz::u8string_view("cast_u8_to_f64"),
	...
	bz::u8string_view("neg_i64"),
	bz::u8string_view("neg_f32"),
	bz::u8string_view("neg_f64"),
	bz::u8string_view("neg_i8_check"),
	bz::u8string_view("neg_i16_check"),
	bz::u8string_view("neg_i32_check"),
	bz::u8string_view("neg_i64_check"),
	bz::u8string_view("add_i8"),
	bz::u8string_view("add_i16"),
	bz::u8string_view("add_i32"),
	bz::u8string_view("add_i64"),
	bz::u8string_view("add_f32"),
	bz::u8string_view("add_f64"),
	bz::u8string_view("add_ptr_i32"),
	bz::u8string_view("add_ptr_u32"),
	bz::u8string_view("add_ptr_i64"),
	bz::u8string_view("add_ptr_u64"),
	bz::u8string_view("add_ptr_const_unchecked"),
	bz::u8string_view("add_i8_check"),
	bz::u8string_view("add_i16_check"),
	bz::u8string_view("add_i32_check"),
	bz::u8string_view("add_i64_check"),
	bz::u8string_view("add_u8_check"),
	bz::u8string_view("add_u16_check"),
	bz::u8string_view("add_u32_check"),
	bz::u8string_view("add_u64_check"),
	bz::u8string_view("add_f32_check"),
	bz::u8string_view("add_f64_check"),
	bz::u8string_view("sub_i8"),
	bz::u8string_view("sub_i16"),
	bz::u8string_view("sub_i32"),
	bz::u8string_view("sub_i64"),
	bz::u8string_view("sub_f32"),
	bz::u8string_view("sub_f64"),
	bz::u8string_view("sub_ptr_i32"),
	bz::u8string_view("sub_ptr_u32"),
	bz::u8string_view("sub_ptr_i64"),
	bz::u8string_view("sub_ptr_u64"),
	bz::u8string_view("sub_i8_check"),
	bz::u8string_view("sub_i16_check"),
	bz::u8string_view("sub_i32_check"),
	bz::u8string_view("sub_i64_check"),
	bz::u8string_view("sub_u8_check"),
	bz::u8string_view("sub_u16_check"),
	bz::u8string_view("sub_u32_check"),
	bz::u8string_view("sub_u64_check"),
	bz::u8string_view("sub_f32_check"),
	bz::u8string_view("sub_f64_check"),
	bz::u8string_view("ptr32_diff"),
	bz::u8string_view("ptr64_diff"),
	bz::u8string_view("ptr32_diff_unchecked"),
	bz::u8string_view("ptr64_diff_unchecked"),
	bz::u8string_view("mul_i8"),
	bz::u8string_view("mul_i16"),
	bz::u8string_view("mul_i32"),
	bz::u8string_view("mul_i64"),
	bz::u8string_view("mul_f32"),
	bz::u8string_view("mul_f64"),
	bz::u8string_view("mul_i8_check"),
	bz::u8string_view("mul_i16_check"),
	bz::u8string_view("mul_i32_check"),
	bz::u8string_view("mul_i64_check"),
	bz::u8string_view("mul_u8_check"),
	bz::u8string_view("mul_u16_check"),
	bz::u8string_view("mul_u32_check"),
	bz::u8string_view("mul_u64_check"),
	bz::u8string_view("mul_f32_check"),
	bz::u8string_view("mul_f64_check"),
	bz::u8string_view("div_i8"),
	bz::u8string_view("div_i16"),
	bz::u8string_view("div_i32"),
	bz::u8string_view("div_i64"),
	bz::u8string_view("div_u8"),
	bz::u8string_view("div_u16"),
	bz::u8string_view("div_u32"),
	bz::u8string_view("div_u64"),
	bz::u8string_view("div_f32"),
	bz::u8string_view("div_f64"),
	bz::u8string_view("div_i8_check"),
	bz::u8string_view("div_i16_check"),
	bz::u8string_view("div_i32_check"),
	bz::u8string_view("div_i64_check"),
	bz::u8string_view("div_f32_check"),
	bz::u8string_view("div_f64_check"),
	bz::u8string_view("rem_i8"),
	bz::u8string_view("rem_i16"),
	bz::u8string_view("rem_i32"),
	bz::u8string_view("rem_i64"),
	bz::u8string_view("rem_u8"),
	bz::u8string_view("rem_u16"),
	bz::u8string_view("rem_u32"),
	bz::u8string_view("rem_u64"),
	bz::u8string_view("not_i1"),
	bz::u8string_view("not_i8"),
	bz::u8string_view("not_i16"),
	bz::u8string_view("not_i32"),
	bz::u8string_view("not_i64"),
	bz::u8string_view("and_i1"),
	bz::u8string_view("and_i8"),
	bz::u8string_view("and_i16"),
	bz::u8string_view("and_i32"),
	bz::u8string_view("and_i64"),
	bz::u8string_view("xor_i1"),
	bz::u8string_view("xor_i8"),
	bz::u8string_view("xor_i16"),
	bz::u8string_view("xor_i32"),
	bz::u8string_view("xor_i64"),
	bz::u8string_view("or_i1"),
	bz::u8string_view("or_i8"),
	bz::u8string_view("or_i16"),
	bz::u8string_view("or_i32"),
	bz::u8string_view("or_i64"),
	bz::u8string_view("shl_i8_signed"),
	bz::u8string_view("shl_i16_signed"),
	bz::u8string_view("shl_i32_signed"),
	bz::u8string_view("shl_i64_signed"),
	bz::u8string_view("shl_i8_unsigned"),
	bz::u8string_view("shl_i16_unsigned"),
	bz::u8string_view("shl_i32_unsigned"),
	bz::u8string_view("shl_i64_unsigned"),
	bz::u8string_view("shr_i8_signed"),
	bz::u8string_view("shr_i16_signed"),
	bz::u8string_view("shr_i32_signed"),
	bz::u8string_view("shr_i64_signed"),
	bz::u8string_view("shr_i8_unsigned"),
	...
	bz::u8string_view("isnormal_f32"),
	bz::u8string_view("isnormal_f64"),
	bz::u8string_view("issubnormal_f32"),
	...
	bz::u8string_view("abs_i64"),
	bz::u8string_view("abs_f32"),
	bz::u8string_view("abs_f64"),
	bz::u8string_view("abs_i8_check"),
	bz::u8string_view("abs_i16_check"),
	bz::u8string_view("abs_i32_check"),
	bz::u8string_view("abs_i64_check"),
	bz::u8string_view("abs_f32_check"),
	bz::u8string_view("abs_f64_check"),
	bz::u8string_view("min_i8"),
	bz::u8string_view("min_i16"),
	bz::u8string_view("min_i32"),
	bz::u8string_view("min_i64"),
	bz::u8string_view("min_u8"),
	bz::u8string_view("min_u16"),
	bz::u8string_view("min_u32"),
	bz::u8string_view("min_u64"),
	bz::u8string_view("min_f32"),
	bz::u8string_view("min_f64"),
	bz::u8string_view("min_f32_check"),
	bz::u8string_view("min_f64_check"),
	bz::u8string_view("max_i8"),
	bz::u8string_view("max_i16"),
	bz::u8string_view("max_i32"),
	bz::u8string_view("max_i64"),
	bz::u8string_view("max_u8"),
	bz::u8string_view("max_u16"),
	bz::u8string_view("max_u32"),
	bz::u8string_view("max_u64"),
	bz::u8string_view("max_f32"),
	bz::u8string_view("max_f64"),
	bz::u8string_view("max_f32_check"),
	bz::u8string_view("max_f64_check"),
	bz::u8string_view("exp_f32"),
	bz::u8string_view("exp_f64"),
	bz::u8string_view("exp_f32_check"),
	bz::u8string_view("exp_f64_check"),
	bz::u8string_view("exp2_f32"),
	bz::u8string_view("exp2_f64"),
	bz::u8string_view("exp2_f32_check"),
	bz::u8string_view("exp2_f64_check"),
	bz::u8string_view("expm1_f32"),
	bz::u8string_view("expm1_f64"),
	bz::u8string_view("expm1_f32_check"),
	bz::u8string_view("expm1_f64_check"),
	bz::u8string_view("log_f32"),
	...
	bz::u8string_view("log1p_f64_check"),
	bz::u8string_view("sqrt_f32"),
	...
	bz::u8string_view("hypot_f64_check"),
	bz::u8string_view("sin_f32"),
	bz::u8string_view("sin_f64"),
	bz::u8string_view("sin_f32_check"),
	bz::u8string_view("sin_f64_check"),
	bz::u8string_view("cos_f32"),
	bz::u8string_view("cos_f64"),
	bz::u8string_view("cos_f32_check"),
	bz::u8string_view("cos_f64_check"),
	bz::u8string_view("tan_f32"),
	bz::u8string_view("tan_f64"),
	bz::u8string_view("tan_f32_check"),
	bz::u8string_view("tan_f64_check"),
	bz::u8string_view("asin_f32"),
	bz::u8string_view("asin_f64"),
	bz::u8string_view("asin_f32_check"),
	bz::u8string_view("asin_f64_check"),
	bz::u8string_view("acos_f32"),
	bz::u8string_view("acos_f64"),
	bz::u8string_view("acos_f32_check"),
	bz::u8string_view("acos_f64_check"),
	bz::u8string_view("atan_f32"),
	bz::u8string_view("atan_f64"),
	bz::u8string_view("atan_f32_check"),
	bz::u8string_view("atan_f64_check"),
	bz::u8string_view("atan2_f32"),
	bz::u8string_view("atan2_f64"),
	bz::u8string_view("atan2_f32_check"),
	bz::u8string_view("atan2_f64_check"),
	bz::u8string_view("sinh_f32"),
	bz::u8string_view("sinh_f64"),
	bz::u8string_view("sinh_f32_check"),
	bz::u8string_view("sinh_f64_check"),
	bz::u8string_view("cosh_f32"),
	bz::u8string_view("cosh_f64"),
	bz::u8string_view("cosh_f32_check"),
	bz::u8string_view("cosh_f64_check"),
	bz::u8string_view("tanh_f32"),
	bz::u8string_view("tanh_f64"),
	bz::u8string_view("tanh_f32_check"),
	bz::u8string_view("tanh_f64_check"),
	bz::u8string_view("asinh_f32"),
	bz::u8string_view("asinh_f64"),
	bz::u8string_view("asinh_f32_check"),
	bz::u8string_view("asinh_f64_check"),
	bz::u8string_view("acosh_f32"),
	bz::u8string_view("acosh_f64"),
	bz::u8string_view("acosh_f32_check"),
	bz::u8string_view("acosh_f64_check"),
	bz::u8string_view("atanh_f32"),
	bz::u8string_view("atanh_f64"),
	bz::u8string_view("atanh_f32_check"),
	bz::u8string_view("atanh_f64_check"),
	bz::u8string_view("erf_f32"),
	bz::u8string_view("erf_f64"),
	bz::u8string_view("erf_f32_check"),
	bz::u8string_view("erf_f64_check"),
	bz::u8string_view("erfc_f32"),
	bz::u8string_view("erfc_f64"),
	bz::u8string_view("erfc_f32_check"),
	bz::u8string_view("erfc_f64_check"),
	bz::u8string_view("tgamma_f32"),
	bz::u8string_view("tgamma_f64"),
	bz::u8string_view("tgamma_f32_check"),
	bz::u8string_view("tgamma_f64_check"),
	bz::u8string_view("lgamma_f32"),
	bz::u8string_view("lgamma_f64"),
	bz::u8string_view("lgamma_f32_check"),
	bz::u8string_view("lgamma_f64_check"),
	bz::u8string_view("bitreverse_u8"),
	bz::u8string_view("bitreverse_u16"),
	bz::u8string_view("bitreverse_u32"),
	bz::u8string_view("bitreverse_u64"),
	bz::u8string_view("popcount_u8"),
	bz::u8string_view("popcount_u16"),
	bz::u8string_view("popcount_u32"),
	bz::u8string_view("popcount_u64"),
	bz::u8string_view("byteswap_u16"),
	bz::u8string_view("byteswap_u32"),
	bz::u8string_view("byteswap_u64"),
	bz::u8string_view("clz_u8"),
	bz::u8string_view("clz_u16"),
	bz::u8string_view("clz_u32"),
	bz::u8string_view("clz_u64"),
	bz::u8string_view("ctz_u8"),
	bz::u8string_view("ctz_u16"),
	bz::u8string_view("ctz_u32"),
	bz::u8string_view("ctz_u64"),
	bz::u8string_view("fshl_u8"),
	bz::u8string_view("fshl_u16"),
	bz::u8string_view("fshl_u32"),
	bz::u8string_view("fshl_u64"),
	bz::u8string_view("fshr_u8"),
	...
	bz::u8string_view("const_memcpy"),
	bz::u8string_view("const_memset_zero"),
	bz::u8string_view("copy_values"),
	bz::u8string_view("copy_overlapping_values"),
	bz::u8string_view("relocate_values"),
	bz::u8string_view("set_values_i1_be"),
	bz::u8string_view("set_values_i8_be"),
	bz::u8string_view("set_values_i16_be"),
	bz::u8string_view("set_values_i32_be"),
	bz::u8string_view("set_values_i64_be"),
	bz::u8string_view("set_values_f32_be"),
	bz::u8string_view("set_values_f64_be"),
	bz::u8string_view("set_values_ptr32_be"),
	bz::u8string_view("set_values_ptr64_be"),
	bz::u8string_view("set_values_i1_le"),
	bz::u8string_view("set_values_i8_le"),
	bz::u8string_view("set_values_i16_le"),
	bz::u8string_view("set_values_i32_le"),
	bz::u8string_view("set_values_i64_le"),
	bz::u8string_view("set_values_f32_le"),
	bz::u8string_view("set_values_f64_le"),
	bz::u8string_view("set_values_ptr32_le"),
	bz::u8string_view("set_values_ptr64_le"),
	bz::u8string_view("set_values_ref"),
	bz::u8string_view("function_call"),
	bz::u8string_view("indirect_function_call"),
	bz::u8string_view("malloc"),
	bz::u8string_view("free"),
	bz::u8string_view("jump"),
	bz::u8string_view("conditional_jump"),
	bz::u8string_view("switch_i1"),
	bz::u8string_view("switch_i8"),
	bz::u8string_view("switch_i16"),
	bz::u8string_view("switch_i32"),
	bz::u8string_view("switch_i64"),
	bz::u8string_view("switch_str"),
	bz::u8string_view("ret"),
	bz::u8string_view("ret_void"),
	bz::u8string_view("unreachable"),
	bz::u8string_view("error"),
	bz::u8string_view("diagnostic_str"),
	bz::u8string_view("print"),
	bz::u8string_view("is_option_set"),
	bz::u8string_view("add_global_array_data"),
	bz::u8string_view("range_bounds_check_signed"),
	bz::u8string_view("range_bounds_check_unsigned"),
	bz::u8string_view("array_bounds_check_i32"),
	...
	bz::u8string_view("start_lifetime"),
	bz::u8string_view("end_lifetime"),
};
static_assert(instruction_names.size() == instruction_list_t::size());

void print_instruction_counts(void)
{
	static_assert(instruction::const_i1 == 1);

	auto kinds = bz::iota(
		static_cast<uint64_t>(instruction::const_i1),
		static_cast<uint64_t>(instruction::end_lifetime) + 1
	).collect();
	kinds.sort([](auto const lhs, auto const rhs) {
		return instruction_counts[lhs] > instruction_counts[rhs];
	});
	for (auto const kind : kinds)
	{
		if (instruction_counts[kind] != 0)
		{
			bz::print("{}: {}\n", instruction_names[kind - 1], instruction_counts[kind]);
		}
	}
}
