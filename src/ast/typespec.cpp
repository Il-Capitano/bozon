...
bool needs_destructor(typespec_view ts) noexcept
{
	...
	{
		return needs_destructor(ts.get<ts_optional>());
	}
	else
	{
		return false;
...
bool is_non_trivial(typespec_view ts) noexcept
{
	...
	{
		return is_non_trivial(ts.get<ts_optional>());
	}
	else
	{
		return false;
...
bool is_default_constructible(typespec_view ts) noexcept
{
	...
	{
		// slices, optionals, function pointers are default constructible
		return true;
	}
}
...
bool is_default_zero_initialized(typespec_view ts) noexcept
{
	...
	{
		// slices, optionals, function pointers are zero initialized
		return true;
	}
}
