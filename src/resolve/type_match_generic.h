...
template<type_match_function_kind kind>
inline match_context_t<kind> change_expr(
...
inline match_context_t<kind> change_dest_and_dest_container(
	match_context_t<kind> const &match_context,
	DestType &&new_dest
)
{
...
template<type_match_function_kind kind>
inline match_context_t<kind> change_dest(
	match_context_t<kind> const &match_context,
...
template<type_match_function_kind kind>
inline strict_match_context_t<kind> make_strict_match_context(
	match_context_t<kind> const &match_context,
	ast::typespec_view source,
	ast::typespec_view dest,
	ast::typespec_view original_dest,
...
template<type_match_function_kind kind>
inline match_function_result_t<kind> generic_type_match_if_expr_complete_type(match_context_t<kind> const &match_context)
{
...
template<type_match_function_kind kind>
inline match_function_result_t<kind> generic_type_match_if_expr(match_context_t<kind> const &match_context)
{
	auto &if_expr = match_context.expr.get_if_expr();
...
template<type_match_function_kind kind>
inline match_function_result_t<kind> generic_type_match_switch_expr_complete_type(match_context_t<kind> const &match_context)
{
...
template<type_match_function_kind kind>
inline match_function_result_t<kind> generic_type_match_switch_expr(match_context_t<kind> const &match_context)
{
	auto &switch_expr = match_context.expr.get_switch_expr();
...
template<type_match_function_kind kind>
inline match_function_result_t<kind> generic_type_match_typename_strict_match(
...
template<type_match_function_kind kind>
inline match_function_result_t<kind> generic_type_match_typename(match_context_t<kind> const &match_context)
{
...
template<type_match_function_kind kind>
inline match_function_result_t<kind> generic_type_match_tuple(match_context_t<kind> const &match_context)
{
	...
	{
		auto const inner_dest = ast::remove_const_or_consteval(dest.blind_get());

		if (!inner_dest.is<ast::ts_tuple>() && !inner_dest.is<ast::ts_array>() && !inner_dest.is<ast::ts_auto>())
		{
			if constexpr (match_context_t<kind>::report_errors)
			{
				match_context.context.report_error(
					expr.src_tokens,
					bz::format("unable to match tuple expression to type '{}'", match_context.dest_container)
				);
			}
			return match_function_result_t<kind>();
		}
...
template<type_match_function_kind kind>
inline match_function_result_t<kind> generic_type_match_strict_match(
...
template<type_match_function_kind kind>
inline match_function_result_t<kind> generic_type_match_base_case(match_context_t<kind> const &match_context)
{
	auto &&expr = match_context.expr;
