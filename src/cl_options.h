...
inline constexpr bz::array ctcli::option_group_multiple<opt_group_id> = []() {
	return bz::array{
		...
		ctcli::create_multiple_group_element<opt_group_id>("1", "Enable basic optimizations", {
			...
			"lower-expect", "targetlibinfo", "tti", "tbaa", "scoped-noalias-aa",
			"assumption-cache-tracker", "profile-summary-info", "annotation2metadata",
			"forceattrs", "inferattrs", "ipsccp", "called-value-propagation", "globalopt",
			"domtree", "mem2reg", "deadargelim", "domtree", "basic-aa", "aa", "loops",
			"lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter", "instcombine",
			"simplifycfg", "basiccg", "globals-aa", "prune-eh", "always-inline", "function-attrs",
			"domtree", "sroa", "basic-aa", "aa", "memoryssa", "early-cse-memssa", "simplifycfg",
			"domtree", "basic-aa", "aa", "loops", "lazy-branch-prob", "lazy-block-freq",
			"opt-remark-emitter", "instcombine", "libcalls-shrinkwrap", "loops", "postdomtree",
			"branch-prob", "block-freq", "lazy-branch-prob", "lazy-block-freq",
			"opt-remark-emitter", "pgo-memop-opt", "simplifycfg", "reassociate", "domtree",
			"loops", "loop-simplify", "lcssa-verification", "lcssa", "basic-aa", "aa",
			"scalar-evolution", "loop-rotate", "memoryssa", "lazy-branch-prob", "lazy-block-freq",
			"licm", "loop-unswitch", "simplifycfg", "domtree", "basic-aa", "aa", "loops",
			"lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter", "instcombine",
			"loop-simplify", "lcssa-verification", "lcssa", "scalar-evolution", "loop-idiom",
			"indvars", "loop-deletion", "loop-unroll", "sroa", "phi-values", "aa", "memdep",
			"memcpyopt", "sccp", "demanded-bits", "bdce", "aa", "lazy-branch-prob",
			"lazy-block-freq", "opt-remark-emitter", "instcombine", "postdomtree", "adce",
			"simplifycfg", "domtree", "basic-aa", "aa", "loops", "lazy-branch-prob",
			"lazy-block-freq", "opt-remark-emitter", "instcombine", "barrier", "basiccg",
			...
			"basic-aa", "aa", "loop-accesses", "demanded-bits", "lazy-branch-prob",
			"lazy-block-freq", "opt-remark-emitter", "inject-tli-mappings", "loop-vectorize",
			"loop-simplify", "scalar-evolution", "aa", "loop-accesses", "lazy-branch-prob",
			"lazy-block-freq", "loop-load-elim", "basic-aa", "aa", "lazy-branch-prob",
			"lazy-block-freq", "opt-remark-emitter", "instcombine", "simplifycfg", "domtree",
			"vector-combine", "basic-aa", "aa", "loops", "lazy-branch-prob", "lazy-block-freq",
			...
			"opt-remark-emitter", "instcombine", "memoryssa", "loop-simplify",
			"lcssa-verification", "lcssa", "scalar-evolution", "lazy-branch-prob",
			"lazy-block-freq", "licm", "opt-remark-emitter", "transform-warning",
			"alignment-from-assumptions", "strip-dead-prototypes", "cg-profile", "domtree",
			"loops", "postdomtree", "branch-prob", "block-freq", "loop-simplify",
			...
			"domtree", "targetlibinfo", "domtree", "loops", "postdomtree", "branch-prob",
			"block-freq", "targetlibinfo", "domtree", "loops", "postdomtree", "branch-prob",
			"block-freq", "targetlibinfo", "domtree", "loops", "lazy-branch-prob",
			"lazy-block-freq",
		}),
		ctcli::create_multiple_group_element<opt_group_id>("2", "Enable more optimizations", {
			...
			"domtree", "mem2reg", "deadargelim", "domtree", "basic-aa", "aa", "loops",
			"lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter", "instcombine",
			"simplifycfg", "basiccg", "globals-aa", "prune-eh", "inline", "openmpopt",
			"function-attrs", "domtree", "sroa", "basic-aa", "aa", "memoryssa",
			"early-cse-memssa", "speculative-execution", "aa", "lazy-value-info",
			"jump-threading", "correlated-propagation", "simplifycfg", "domtree", "basic-aa",
			"aa", "loops", "lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter",
			"instcombine", "libcalls-shrinkwrap", "loops", "postdomtree", "branch-prob",
			"block-freq", "lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter",
			"pgo-memop-opt", "basic-aa", "aa", "loops", "lazy-branch-prob", "lazy-block-freq",
			...
			"lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter", "instcombine",
			"loop-simplify", "lcssa-verification", "lcssa", "scalar-evolution", "loop-idiom",
			"indvars", "loop-deletion", "loop-unroll", "sroa", "aa", "mldst-motion", "phi-values",
			"aa", "memdep", "lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter", "gvn",
			"phi-values", "basic-aa", "aa", "memdep", "memcpyopt", "sccp", "demanded-bits",
			"bdce", "aa", "lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter",
			"instcombine", "lazy-value-info", "jump-threading", "correlated-propagation",
			"postdomtree", "adce", "basic-aa", "aa", "memoryssa", "dse", "loops", "loop-simplify",
			"lcssa-verification", "lcssa", "aa", "scalar-evolution", "lazy-branch-prob",
			"lazy-block-freq", "licm", "simplifycfg", "domtree", "basic-aa", "aa", "loops",
			"lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter", "instcombine", "barrier",
			...
			"domtree", "loops", "loop-simplify", "lcssa-verification", "lcssa", "basic-aa", "aa",
			...
			"branch-prob", "block-freq", "scalar-evolution", "basic-aa", "aa", "loop-accesses",
			"demanded-bits", "lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter",
			"inject-tli-mappings", "loop-vectorize", "loop-simplify", "scalar-evolution", "aa",
			"loop-accesses", "lazy-branch-prob", "lazy-block-freq", "loop-load-elim", "basic-aa",
			"aa", "lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter", "instcombine",
			"simplifycfg", "domtree", "loops", "scalar-evolution", "basic-aa", "aa",
			"demanded-bits", "lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter",
			"inject-tli-mappings", "slp-vectorizer", "vector-combine", "opt-remark-emitter",
			...
			"scalar-evolution", "lazy-branch-prob", "lazy-block-freq", "licm",
			"opt-remark-emitter", "transform-warning", "alignment-from-assumptions",
			"strip-dead-prototypes", "globaldce", "constmerge", "cg-profile", "domtree", "loops",
			"postdomtree", "branch-prob", "block-freq", "loop-simplify", "lcssa-verification",
			"lcssa", "basic-aa", "aa", "scalar-evolution", "block-freq", "loop-sink",
			"lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter", "instsimplify",
			"div-rem-pairs", "simplifycfg", "annotation-remarks", "verify", "domtree",
		...
		ctcli::create_multiple_group_element<opt_group_id>("3", "Enable even more optimizations", {
			...
			"lower-expect", "targetlibinfo", "tti", "tbaa", "scoped-noalias-aa",
			"assumption-cache-tracker", "profile-summary-info", "annotation2metadata",
			"forceattrs", "inferattrs", "domtree", "callsite-splitting", "ipsccp",
			...
			"prune-eh", "inline", "openmpopt", "function-attrs", "argpromotion", "domtree",
			"sroa", "basic-aa", "aa", "memoryssa", "early-cse-memssa", "speculative-execution",
			"aa", "lazy-value-info", "jump-threading", "correlated-propagation", "simplifycfg",
			"domtree", "aggressive-instcombine", "basic-aa", "aa", "loops", "lazy-branch-prob",
			"lazy-block-freq", "opt-remark-emitter", "instcombine", "libcalls-shrinkwrap",
			"loops", "postdomtree", "branch-prob", "block-freq", "lazy-branch-prob",
			"lazy-block-freq", "opt-remark-emitter", "pgo-memop-opt", "basic-aa", "aa", "loops",
			"lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter", "tailcallelim",
			"simplifycfg", "reassociate", "domtree", "loops", "loop-simplify",
			"lcssa-verification", "lcssa", "basic-aa", "aa", "scalar-evolution", "loop-rotate",
			"memoryssa", "lazy-branch-prob", "lazy-block-freq", "licm", "loop-unswitch",
			"simplifycfg", "domtree", "basic-aa", "aa", "loops", "lazy-branch-prob",
			"lazy-block-freq", "opt-remark-emitter", "instcombine", "loop-simplify",
			"lcssa-verification", "lcssa", "scalar-evolution", "loop-idiom", "indvars",
			"loop-deletion", "loop-unroll", "sroa", "aa", "mldst-motion", "phi-values", "aa",
			"memdep", "lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter", "gvn",
			"phi-values", "basic-aa", "aa", "memdep", "memcpyopt", "sccp", "demanded-bits",
			"bdce", "aa", "lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter",
			"instcombine", "lazy-value-info", "jump-threading", "correlated-propagation",
			"postdomtree", "adce", "basic-aa", "aa", "memoryssa", "dse", "loops", "loop-simplify",
