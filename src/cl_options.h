...
inline constexpr bz::array ctcli::option_group_multiple<opt_group_id> = []() {
	return bz::array{
		...
		ctcli::create_multiple_group_element<opt_group_id>("1", "Enable basic optimizations", {
			...
			"deadargelim", "domtree", "basic-aa", "aa", "loops", "lazy-branch-prob",
			"lazy-block-freq", "opt-remark-emitter", "instcombine", "simplifycfg", "basiccg",
			"globals-aa", "prune-eh", "always-inline", "function-attrs", "domtree", "sroa",
			"basic-aa", "aa", "memoryssa", "early-cse-memssa", "simplifycfg", "domtree",
			...
			"loop-idiom", "indvars", "loop-deletion", "loop-unroll", "sroa", "phi-values",
			"aa", "memdep", "memcpyopt", "sccp", "demanded-bits", "bdce", "aa",
			"lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter", "instcombine",
			"postdomtree", "adce", "simplifycfg", "domtree", "basic-aa", "aa", "loops",
			"lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter", "instcombine",
			"barrier", "basiccg", "rpo-function-attrs", "globalopt", "globaldce", "basiccg",
			"globals-aa", "domtree", "float2int", "lower-constant-intrinsics", "domtree",
			"loops", "loop-simplify", "lcssa-verification", "lcssa", "basic-aa", "aa",
			...
			"loop-accesses", "lazy-branch-prob", "lazy-block-freq", "loop-load-elim",
			"basic-aa", "aa", "lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter",
			"instcombine", "simplifycfg", "domtree", "vector-combine", "basic-aa", "aa",
			...
			"strip-dead-prototypes", "cg-profile", "domtree", "loops", "postdomtree",
		...
		ctcli::create_multiple_group_element<opt_group_id>("2", "Enable more optimizations", {
			...
			"deadargelim", "domtree", "basic-aa", "aa", "loops", "lazy-branch-prob",
			"lazy-block-freq", "opt-remark-emitter", "instcombine", "simplifycfg", "basiccg",
			"globals-aa", "prune-eh", "inline", "openmpopt", "function-attrs", "domtree",
			"sroa", "basic-aa", "aa", "memoryssa", "early-cse-memssa",
			"speculative-execution", "aa", "lazy-value-info", "jump-threading",
			"correlated-propagation", "simplifycfg", "domtree", "basic-aa", "aa", "loops",
			"lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter", "instcombine",
			...
			"loop-accesses", "lazy-branch-prob", "lazy-block-freq", "loop-load-elim",
			"basic-aa", "aa", "lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter",
			"instcombine", "simplifycfg", "domtree", "loops", "scalar-evolution", "basic-aa",
			"aa", "demanded-bits", "lazy-branch-prob", "lazy-block-freq", "opt-remark-emitter",
			...
			"scalar-evolution", "lazy-branch-prob", "lazy-block-freq", "licm",
			"opt-remark-emitter", "transform-warning", "alignment-from-assumptions",
			"strip-dead-prototypes", "globaldce", "constmerge", "cg-profile", "domtree",
