...
constexpr auto warning_infos = []() {
	...
	result_t result = {
		...
		T{ warning_kind::sizeof_reference_expression, "sizeof-reference-expression", "Applying 'sizeof' to an expression with reference type, which may result in unexpected results" },
