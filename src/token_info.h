...
//	constexpr uint64_t both_type_op_flags   = unary_type_op_flags | binary_type_op_flags;
	...
	result[lex::token::kw_function]      = { lex::token::kw_function,      "function",      "", keyword_flags | expr_type_flags };
	...
	result[lex::token::kw_enum]          = { lex::token::kw_enum,          "enum",          "", keyword_flags                   };
